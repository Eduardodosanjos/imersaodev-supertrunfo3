...
var cartaNaruto = {
    nome: "Naruto",
    imagem: "https://www.einerd.com.br/wp-content/uploads/2020/11/boruto-naruto-forma-final-e1606135074767-890x464.jpg",
    atributos: {
        ataque: 98,
        defesa: 95,
        magia: 100
...
var cartaMarvel = {
    nome: "Capitã Marvel",
    imagem: "https://i.pinimg.com/564x/f1/5f/18/f15f18d9ab9b4c98b8829267f5c6223b.jpg",
    atributos: {
        ataque: 90,
        defesa: 80,
        magia: 95
...
function jogar() {
  ...
  if(cartas.length == 0){
    ...
    if(pontosJogador > pontosMaquina){
      htmlResultado = '<p class="resultado-final">Final de Jogo: Venceu</p>'
    }
    else if(pontosMaquina > pontosJogador){
      htmlResultado = '<p class="resultado-final">Final de Jogo: Perdeu</p>'
    }
    else{
      htmlResultado = '<p class="resultado-final">Final de Jogo: Empatou</p>'
    }
  }
  else{
